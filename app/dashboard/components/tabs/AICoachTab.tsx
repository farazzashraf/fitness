...
export function AICoachTab({ bp, user }: { bp: 'mobile' | 'tablet' | 'desktop'; user: UserData }) {
  ...
  if (!isElite) return <LockedOverlay title="AI Coaching Q&A" message="Get 24/7 access to our fine-tuned fitness AI model. Ask about form, substitutes, and custom programming." unlockTier="ELITE" ctaLink="/checkout?plan=elite" />
